...
if(isset($_POST['like_posts'])){
    ...
    header('Location: ./search.php?search_box='. $search_box);
    exit();
}
...
<section class="posts-grid">
    ...
    <div class="box-container">
        ...
        if(isset($_GET['search_box']) or isset($_GET['search_btn'])){
            ...
            $select_posts = $conn->prepare("SELECT * FROM  `posts` WHERE 
            title LIKE '%{$search_box}%' OR category LIKE '%{$search_box}%' AND status= ?");
